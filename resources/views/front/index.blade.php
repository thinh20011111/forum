...
<div class="theme-layout">
    ...
    <div class="topbar stick">
        ...
        <div class="top-area">
            <ul class="main-menu">
                <li>
                    <a href="./" title="">Có gì mới</a>                  
                </li>
                <li>
                    <a href="./" title="">Thư viện ảnh</a>                   
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="searched">
                        <form method="post" action="" class="form-search">
                            ...
                            <button data-ripple type="submit" id="testbtn" onclick="console.log('aaaa')"><i class="ti-search"></i></button>
                        </form>
                    </div>
                </li>
                <li>
            ...
            <div class="user-img">
                <img src="front/img/resources/admin.jpg" alt="">
                ...
                <div class="user-setting">
                    ...
                    <a href="./account/logout" title=""><i class="ti-power-off"></i>Logout</a>
                </div>
            </div>
        </div>
    </div><!-- topbar -->
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static">
                                    ...
                                    <div class="widget stick-widget">
                                        ...
                                        <ul class="followers">
                                            <li>
                                                <figure><img src="front/img/resources/friend-avatar2.jpg" alt=""></figure>
                                            ...
                                            <li>
                                                <figure><img src="front/img/resources/friend-avatar4.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="front/img/resources/friend-avatar6.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="front/img/resources/friend-avatar8.jpg" alt=""></figure>
                                                <div class="friend-meta">
                                            ...
                                            <li>
                                                <figure><img src="front/img/resources/friend-avatar3.jpg" alt=""></figure>
                                                <div class="friend-meta">
                            ...
                            <div class="col-lg-6">
                                <div class="central-meta">
                                    <div class="new-postbox">
                                        <figure>
                                            <img src="front/img/resources/admin2.jpg" alt="">
                                        </figure>
                                        <div class="newpst-input">
                                            <form method="post">
                                                <textarea rows="2" placeholder="write something" id="content"></textarea>
                                ...
                                <div class="loadMore">
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img src="front/img/resources/friend-avatar10.jpg" alt="">
                                                </figure>
                                                ...
                                                <div class="post-meta">
                                                    <img src="front/img/resources/user-post.jpg" alt="">
                                                ...
                                                <ul class="we-comet">
                                                    <li>
                                                        <div class="comet-avatar">
                                                            <img src="front/img/resources/comet-1.jpg" alt="">
                                                        </div>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="comet-avatar">
                                                                    <img src="front/img/resources/comet-2.jpg" alt="">
                                                                </div>
                                                                <div class="we-comment">
                                                                    <div class="coment-head">
                                                            ...
                                                            <li>
                                                                <div class="comet-avatar">
                                                                    <img src="front/img/resources/comet-3.jpg" alt="">
                                                                </div>
                                                                <div class="we-comment">
                                                                    <div class="coment-head">
                                    ...
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img src="front/img/resources/nearly1.jpg" alt="">
                                                </figure>
                                                <div class="friend-name">
                                    ...
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img src="front/img/resources/nearly6.jpg" alt="">
                                                </figure>
                                                <div class="friend-name">
                                    ...
                                    <div class="central-meta item">
                                        <div class="user-post">
                                            <div class="friend-info">
                                                <figure>
                                                    <img alt="" src="front/img/resources/friend-avatar10.jpg">
                                                </figure>
                                                <div class="friend-name">
                                                ...
                                                <div class="post-meta">
                                                    <div class="linked-image align-left">
                                                        <a title="" href="#"><img alt="" src="front/img/resources/page1.jpg"></a>
                                                    </div>
                                                    <div class="detail">
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static">
                                    <div class="widget">
                                        ...
                                        <div class="your-page">
                                            <figure>
                                                <a href="#" title=""><img src="front/img/resources/friend-avatar9.jpg" alt=""></a>
                                            </figure>
                                            <div class="page-meta">
                                    ...
                                    <div class="widget friend-list stick-widget">
                                        ...
                                        <div class="chat-box">
                                            ...
                                            <div class="chat-list">
                                                <ul>
                                                    <li class="me">
                                                        <div class="chat-thumb"><img src="front/img/resources/chatlist1.jpg" alt=""></div>
                                                    ...
                                                    <li class="you">
                                                        <div class="chat-thumb"><img src="front/img/resources/chatlist2.jpg" alt=""></div>
                                                        <div class="notification-event">
                                                            <span class="chat-message-item">
                                                                Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
                                                            </span>
